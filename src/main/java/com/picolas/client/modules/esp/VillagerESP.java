...
import com.picolas.client.VersionUtil; // For 1.21.4 - change to VersionUtil2 for 1.21.5
...
public class VillagerESP extends Module {
    ...
    public VillagerESP() {
        super(PicolasClientAddon.esp, "villager-esp", "Detects villagers and zombie villagers in the world");
    }
