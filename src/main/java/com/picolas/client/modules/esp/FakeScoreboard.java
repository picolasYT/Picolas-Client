package com.picolas.client.modules.esp;
...
public class FakeScoreboard extends Module {
    private static final String SCOREBOARD_NAME = "picolas_custom";
    ...
    private final Setting<String> footer = sgStats.add(new StringSetting.Builder()
            .name("footer")
            .defaultValue(" Picolas(67ms)")
            .onChanged(s -> safeUpdate())
            .build());

    public FakeScoreboard() {
        super(PicolasClientAddon.esp, "fake-scoreboard", "Custom scoreboard overlay for Picolas.");
    }
    ...
    public void updateScoreboard() {
        if (mc.world == null || mc.player == null) return;
            ...
            for (int i = 0; i < entries.size(); i++) {
                String teamName = "picolas_team_" + i;
