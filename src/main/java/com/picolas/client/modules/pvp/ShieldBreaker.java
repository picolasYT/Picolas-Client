...
public class ShieldBreaker extends Module {
    ...
    public ShieldBreaker() {
        super(PicolasClientAddon.pvp, "shield-breaker", "Automatically breaks player shields with axe then switches back to weapon for kill.");
    }
        ...
        if (entityHit.getEntity() instanceof PlayerEntity player) {
            ...
            if (isUsingShield(player)) {
                ...
                if (!autoBreak.get() && isAttacking) {
                    ...
                    originalSlot = com.picolas.client.utils.InventoryUtils.getSelectedSlot(mc.player.getInventory());
