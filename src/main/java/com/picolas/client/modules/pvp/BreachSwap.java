...
public class BreachSwap extends Module {
    ...
    public BreachSwap() {
        super(PicolasClientAddon.pvp, "breach-swap", "Swaps with the breach mace in a target slot on attack");
    }
    ...
    private void onAttack(AttackEntityEvent event) {
        ...
        if (swapBack.get()) {
            ...
            prevSlot = com.picolas.client.utils.InventoryUtils.getSelectedSlot(mc.player.getInventory());
        }
