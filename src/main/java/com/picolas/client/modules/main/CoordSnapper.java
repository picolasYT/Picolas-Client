...
public class CoordSnapper extends Module {
    ...
    public CoordSnapper() {
        super(PicolasClientAddon.CATEGORY, "coord-snapper", "Copies your coordinates to clipboard and optionally sends them via webhook.");
    }
    ...
    private void sendWebhook(int x, int y, int z) {
        new Thread(() -> {
            try {
                ...
                json.addProperty("username", "Picolas Webhook");
                ...
                footer.addProperty("text", "Sent by Picolas");
