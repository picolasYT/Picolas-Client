...
public class PremiumTunnelBaseFinder extends Module {
    ...
    public PremiumTunnelBaseFinder() {
        super(PicolasClientAddon.CATEGORY, "premium-tunnel-base-finder", "Advanced tunnel mining with enhanced lava detection, pearl-through feature, and improved safety systems.");
    }
