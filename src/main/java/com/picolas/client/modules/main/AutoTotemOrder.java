...
public class AutoTotemOrder extends Module {
    ...
    public AutoTotemOrder() {
        super(PicolasClientAddon.CATEGORY, "auto-totem-order", "Automatically buys totems and sells them in orders for profit with player targeting");
    }
    ...
    public void onActivate() {
        ...
        if (notifications.get()) {
            ...
            info("🚀 FAST AutoTotemOrder activated! Minimum: %s%s", minPrice.get(), modeInfo);
        }
    }
