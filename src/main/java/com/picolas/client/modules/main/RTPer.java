...
public class RTPer extends Module {
    ...
    public RTPer() {
        super(PicolasClientAddon.CATEGORY, "rtper", "RTP to specific coordinates or find specific biomes.");
    }
    ...
    private void handleBiomeMode() {
        if (biomeFound) {
            ...
            if (disconnectOnReach.get()) {
                if (notifications.get()) info("Disconnecting...");
                disconnectWithMessage("Picolas: found requested biome");
            }
