...
import com.picolas.client.modules.esp.*;
import com.picolas.client.modules.main.*;
import com.picolas.client.modules.pvp.*;
...
public class PicolasClientAddon extends MeteorAddon {

    public static final Category CATEGORY = new Category("Picolas Client", new ItemStack(Items.CAKE));
    public static final Category esp = new Category("Picolas ESP", new ItemStack(Items.VINE));
    public static final Category pvp = new Category("Picolas PVP", new ItemStack(Items.DIAMOND_SWORD));
